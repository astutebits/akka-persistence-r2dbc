...
import static akka.persistence.postgresql.snapshot.SnapshotStoreStatements.deleteSnapshotQuery;
import static akka.persistence.postgresql.snapshot.SnapshotStoreStatements.deleteSnapshotsQuery;
import static akka.persistence.postgresql.snapshot.SnapshotStoreStatements.fetchSnapshotQuery;
import static akka.persistence.postgresql.snapshot.SnapshotStoreStatements.upsertSnapshotQuery;
